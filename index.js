      ...
      document.getElementById("Selectstory").onchange=function(){
        ...
        x=document.getElementById("combobox1").value;
          ...
          if (x=='1'){
            ...
            document.getElementById('content').innerHTML="Once upon a time a thief stole a bell from the temple. That thief was hunted down by a tiger. In the process the bell fell on the ground. The monkeys saw the bell and carried it home. From that day onwards the monkeys used to ring the bell every night. The noise scared the villagers. One day they discovered the body of the thief and believed that an evil spirit is haunting the village.<br><br>Only one women had the courage to find out what was making the noise, and entured inside the forest. She saw the monkeys were ringing the bell. The women was an opportunist. She went upto the king and told him that she could get rid of the spirit by having a prayer. For this purpose she took huge amount of money from the king. Soon she got the bell from the monkeys and kept the money to herself!<br><br>It was cleaverness and fearlessness that not only helped her tackle the problem but also make profit out of it."
          } 
          else if (x=='4') {
            document.getElementById('storyTitle').textContent='The Rabbit And The Tortoise';
            document.getElementById('storyImage').src="images/image4.jpg";
            document.getElementById('content').innerHTML="Once upon a time there lived a rabbit, who was very vain. He was very proud about the fact that he could run very fast. One day a tortoise challenged him to race. The rabbit wondered how such a slow animal could beat him, and accepted the challenge.<br><br>Next day, the race began and the rabbit covered a great distance in no time. He saw that the tortoise lagged way behind. Knowing that he had enough time he stopped to rest under a shaddy tree. He didn\'t realise when he fell asleep. At the same time tortoise continues his journey slowly and steadily. When the rabbit woke up, he ran fast towards the finishing point. But, it was too late. He saw the tortoise ahead of him, crossing the finishing line.<br><br>It was then that the rabbit realised that speed is not the only important criteria for winning a race. One should possess the right attitude and should be determined and hardworking as well."
          } 
          else if (x=='5') {
            document.getElementById('storyTitle').textContent='The Wise Elephant';
            document.getElementById('storyImage').src="images/image5.jpg";
            document.getElementById('content').innerHTML="Once a group of eleplants, due to scarcity of water, were forced to leave their territory and migrate to a nearby place, where water was available in abundance. They decided to stay in that area.<br><br>The rabbits who inhabited that area got highly worried as their water was now being consumed by the elephants. Moreever, a lot of them were being squashed under the elephants\' feet.<br><br>One day, the leader of the rabbits went to the elephants\'leader. The elephants\' leader, on hearing this, felt very guilty and sorry. He decided to leave immediately with this group. He could have overlooked the problem faced by the rabbits due to their migrating, and chosen to remain in the the same territory, but he decided not to do so. He respected the fact that the area first belonged to the rabbits. Thus, the wise elephant took the right decision and saved the rabbits from their worries."
          }
          else if (x=='6') {
            ...
            document.getElementById('content').innerHTML="There lived a monkey who was friends with a crocodile. He used to give him mangoes from the tree. The crocodile found them very delicious. Once the crocodile took the mangoes for his wife. When she ate the mangoes she thought, \"The monkeys who feeds on these mangoes must be much more delicious.\" She decided to eat the monkey and percuaded her husband to invite him for dinner to their house so that she can eat him.<br><br>Next day the crocodile invited the monkey. The monkey who did not know how to swim, sat on his back. On the way, the crocodile revealed to the monkey about his wife's plan. The clever monkey said,\"Dear friend, you should have told this to me before as I don\'t carry my heart with me. It is in my house. If you want I can get it for your wife to eat.\" The foolish crocodile believed him. When he came near the monkey'\s tree, the monkey jumped onto the tree and saved his life."
          }
          else if (x=='7') {
            ...
            document.getElementById('content').innerHTML="Once upon a time there lived a turtle in a pond. He was friends with two swans who used to come to the same pond to have water. They spent good time together, talking to each other. The swans were very wise, unlike the turtle who was very talkative. He was very impatient and used to cut short their conversation.<br><br>Once a drout hit that area and the pond began drying up. The turtle got very worried, and so did the two swans. The swans came up with an idea. They said to the turtle, \"We can fly you to a new area with plenty of water. For this we will hold the two ends of a stick in our beak and you have to grab the stick with your mouth.\" The turtle agreed.<br><br>When they started flying in the sky, the turtle was surprised to see the scenic view. As soon as he opened his mouth to talk, he fell down and died.<br><br>Thus, it is advised not to talk unecessarity."
          } 
          else if (x=='8') {
            ...
            document.getElementById('content').innerHTML="There lived a donkey who used to work with a washerman. He was ill treated and malnourished. Every night he was left out in the open so that he could eat the grass. One day he met a fox, who told him about a garden filled with cucumbers. He asked the donkey to accompany him there and have a feast. The donkey agreed.<br><br>One night while they were feasting in the garden, the donkey has a whim to sing out loudly. Inspite of the fox\'s several appeals not to do so, still he started singing loudly. On hearing the donkey\'s bray, he farmers rushed towards the field. Seeing the farmers the clever fox and the stupid donkey, who was busy singing, faced thee farmer\'s thrashing.<br><br>After the farmers left, the fox rushed to meet the donkey who was now tied to a heavy stone around his neck. The fox said, \"So, you got the prize for singing. I wish you had paid heed to my advice\"."
          }
          else if (x=='14') {
            ...
            document.getElementById('content').innerHTML="There lived three fishes in a pond , along with several other fishes. The wise among them Titu,  believed in taking preccation before the trouble comes. Tilu, on the other hand, believed in facing the trouble. Tinu believed that whatever has to happen will happen and nothing can prevent it.<br><br>One day Titu heard two fisherman talking about their plan to catch fish in the pond. On hearing this, Titu decided to leave the pond as soon as possible and asked both, Tilu and Tinu to accompany her. Both refused. Anyhow, Titu left for a safer place. Next day when the fisherman came with their net, Tilu quickly thought of a plan to save her life and hid herself in the deepest area in the pond. Tinu remained indifferent to the entire situation. As a result Tinu, along with other fishes, got caught in the net and soon died.<br><br>It was Tinu\'s foolishness that resulted in her death and Titu\'s sensibillity and Tilu\'s alertness that saved their life."
          } else {
